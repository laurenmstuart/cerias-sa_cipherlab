...
def encrypt_message(key, message):
    ...
    ## you can use a different way to keep track of where in the key we should be; this is a suggestion.
    ...
    for letter in message:
        ...
        if ### != -1 and ### != -1: ##(replace '###' with your variable names)
